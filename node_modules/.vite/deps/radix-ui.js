import {
  ...
  size,
  useFloating
} from "./chunk-MX7KVW4O.js";
import {
  hideOthers,
  init_es2015
} from "./chunk-OQZGV5AE.js";
import {
  autoUpdate
} from "./chunk-YEJLWUFY.js";
import {
  Toggle,
...
import {
  ...
  useCallbackRef,
  useIsHydrated
} from "./chunk-T7W7UUKA.js";
import "./chunk-346YUHEA.js";
import {
  Primitive,
  Root,
  composeRefs,
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime11.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React25.Children.map(children, (child) => (0, import_jsx_runtime11.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime11.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React30.useState(null);
  const [bubbleInput, setBubbleInput] = React30.useState(null);
...
var CheckboxTrigger = React30.forwardRef(
  ({ __scopeCheckbox, onKeyDown, onClick, ...checkboxProps }, forwardedRef) => {
    ...
    const initialCheckedStateRef = React30.useRef(checked);
    React30.useEffect(() => {
...
var CheckboxIndicator = React30.forwardRef(
  (props, forwardedRef) => {
...
var CheckboxBubbleInput = React30.forwardRef(
  ({ __scopeCheckbox, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React30.useRef(isIndeterminate(checked) ? false : checked);
    return (0, import_jsx_runtime14.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
var PopperContent = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const [arrow2, setArrow] = React32.useState(null);
...
var NavigationMenuViewportImpl = React41.forwardRef((props, forwardedRef) => {
  ...
  const [size2, setSize] = React41.useState(null);
...
var Popover = (props) => {
  ...
  return (0, import_jsx_runtime28.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime28.jsx)(
    PopoverProvider,
    {
...
var Progress = React45.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime29.jsx)(ProgressProvider, { scope: __scopeProgress, value, max, children: (0, import_jsx_runtime29.jsx)(
      Primitive.div,
      {
        "aria-valuemax": max,
        "aria-valuemin": 0,
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime33.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime33.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
...
var SliderThumb = React50.forwardRef(
  (props, forwardedRef) => {
    ...
    const index = React50.useMemo(
      () => thumb ? getItems().findIndex((item) => item.ref.current === thumb) : -1,
      [getItems, thumb]
    );
    return (0, import_jsx_runtime35.jsx)(SliderThumbImpl, { ...props, ref: composedRefs, index });
  }
);
...
var ToastImpl = React53.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime38.jsxs)(import_jsx_runtime38.Fragment, { children: [
      ...
      (0, import_jsx_runtime38.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM4.createPortal(
...
var ToggleGroup = import_react7.default.forwardRef((props, forwardedRef) => {
  ...
  if (type === "single") {
    ...
    return (0, import_jsx_runtime39.jsx)(ToggleGroupImplSingle, { ...singleProps, ref: forwardedRef });
  }
  if (type === "multiple") {
    const multipleProps = toggleGroupProps;
    return (0, import_jsx_runtime39.jsx)(ToggleGroupImplMultiple, { ...multipleProps, ref: forwardedRef });
  }
...
var ToggleGroupImplSingle = import_react7.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime39.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime39.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = import_react7.default.forwardRef((props, forwardedRef) => {
  ...
  return (0, import_jsx_runtime39.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      children: (0, import_jsx_runtime39.jsx)(ToggleGroupImpl, { ...toggleGroupMultipleProps, ref: forwardedRef })
    }
  );
});
ToggleGroup.displayName = TOGGLE_GROUP_NAME;
...
var ToggleGroupImpl = import_react7.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime39.jsx)(ToggleGroupContext, { scope: __scopeToggleGroup, rovingFocus, disabled, children: rovingFocus ? (0, import_jsx_runtime39.jsx)(
      Root9,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        dir: direction,
        loop,
        children: (0, import_jsx_runtime39.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime39.jsx)(Primitive.div, { ...commonProps, ref: forwardedRef }) });
  }
);
...
var ToggleGroupItem = import_react7.default.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.rovingFocus ? (0, import_jsx_runtime39.jsx)(
      Item2,
      {
        asChild: true,
        ...rovingFocusGroupScope,
        ...
        active: pressed,
        ref,
        children: (0, import_jsx_runtime39.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef })
      }
    ) : (0, import_jsx_runtime39.jsx)(ToggleGroupItemImpl, { ...commonProps, ref: forwardedRef });
  }
);
...
var Toolbar = React55.forwardRef(
  (props, forwardedRef) => {
    ...
    const direction = useDirection(dir);
    return (0, import_jsx_runtime40.jsx)(ToolbarProvider, { scope: __scopeToolbar, orientation, dir: direction, children: (0, import_jsx_runtime40.jsx)(
      Root9,
      {
        asChild: true,
        ...rovingFocusGroupScope,
...
var ToolbarButton = React55.forwardRef(
  (props, forwardedRef) => {
    ...
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime40.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: !props.disabled, children: (0, import_jsx_runtime40.jsx)(Primitive.button, { type: "button", ...buttonProps, ref: forwardedRef }) });
  }
);
...
var ToolbarLink = React55.forwardRef(
  (props, forwardedRef) => {
    ...
    const rovingFocusGroupScope = useRovingFocusGroupScope7(__scopeToolbar);
    return (0, import_jsx_runtime40.jsx)(Item2, { asChild: true, ...rovingFocusGroupScope, focusable: true, children: (0, import_jsx_runtime40.jsx)(
      Primitive.a,
      {
        ...linkProps,
        ref: forwardedRef,
...
var ToolbarToggleItem = React55.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime40.jsx)(ToolbarButton, { asChild: true, ...scope, children: (0, import_jsx_runtime40.jsx)(Item26, { ...toggleGroupScope, ...toggleItemProps, ref: forwardedRef }) });
  }
);
...
var TooltipProvider = (props) => {
  ...
  const isOpenDelayedRef = React56.useRef(true);
  const isPointerInTransitRef = React56.useRef(false);
  ...
  return (0, import_jsx_runtime41.jsx)(
    TooltipProviderContextProvider,
    {
      ...
      isOpenDelayedRef,
      delayDuration,
      onOpen: React56.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        isOpenDelayedRef.current = false;
      }, []),
      onClose: React56.useCallback(() => {
        window.clearTimeout(skipDelayTimerRef.current);
        skipDelayTimerRef.current = window.setTimeout(
      ...
      onPointerInTransitChange: React56.useCallback((inTransit) => {
...
var Tooltip = (props) => {
  ...
  const wasOpenDelayedRef = React56.useRef(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: (open2) => {
  ...
  const stateAttribute = React56.useMemo(() => {
  ...
  return (0, import_jsx_runtime41.jsx)(Root25, { ...popperScope, children: (0, import_jsx_runtime41.jsx)(
    TooltipContextProvider,
    {
      ...
      trigger,
      onTriggerChange: setTrigger,
      onTriggerEnter: React56.useCallback(() => {
        if (providerContext.isOpenDelayedRef.current) handleDelayedOpen();
        else handleOpen();
      }, [providerContext.isOpenDelayedRef, handleDelayedOpen, handleOpen]),
      onTriggerLeave: React56.useCallback(() => {
...
var TooltipTrigger = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    const isPointerDownRef = React56.useRef(false);
    const hasPointerMoveOpenedRef = React56.useRef(false);
    const handlePointerUp = React56.useCallback(() => isPointerDownRef.current = false, []);
    React56.useEffect(() => {
...
var TooltipPortal = (props) => {
  ...
  return (0, import_jsx_runtime41.jsx)(PortalProvider5, { scope: __scopeTooltip, forceMount, children: (0, import_jsx_runtime41.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime41.jsx)(Portal, { asChild: true, container, children }) }) });
};
TooltipPortal.displayName = PORTAL_NAME11;
var CONTENT_NAME15 = "TooltipContent";
var TooltipContent = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime41.jsx)(Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? (0, import_jsx_runtime41.jsx)(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime41.jsx)(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
var TooltipContentHoverable = React56.forwardRef((props, forwardedRef) => {
  const context = useTooltipContext(CONTENT_NAME15, props.__scopeTooltip);
  const providerContext = useTooltipProviderContext(CONTENT_NAME15, props.__scopeTooltip);
  const ref = React56.useRef(null);
  const composedRefs = useComposedRefs(forwardedRef, ref);
  const [pointerGraceArea, setPointerGraceArea] = React56.useState(null);
  const { trigger, onClose } = context;
  const content = ref.current;
  const { onPointerInTransitChange } = providerContext;
  const handleRemoveGraceArea = React56.useCallback(() => {
    setPointerGraceArea(null);
    onPointerInTransitChange(false);
  }, [onPointerInTransitChange]);
  const handleCreateGraceArea = React56.useCallback(
    (event, hoverTarget) => {
  ...
  return (0, import_jsx_runtime41.jsx)(TooltipContentImpl, { ...props, ref: composedRefs });
});
var [VisuallyHiddenContentContextProvider, useVisuallyHiddenContentContext] = createTooltipContext(TOOLTIP_NAME, { isInside: false });
var Slottable2 = createSlottable("TooltipContent");
var TooltipContentImpl = React56.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeTooltip,
      children,
    ...
    return (0, import_jsx_runtime41.jsx)(
      DismissableLayer,
      {
        ...
        onFocusOutside: (event) => event.preventDefault(),
        onDismiss: onClose,
        children: (0, import_jsx_runtime41.jsxs)(
          Content4,
          {
            "data-state": context.stateAttribute,
            ...popperScope,
            ...
            children: [
              (0, import_jsx_runtime41.jsx)(Slottable2, { children }),
              (0, import_jsx_runtime41.jsx)(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: (0, import_jsx_runtime41.jsx)(Root2, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
var TooltipArrow = React56.forwardRef(
  (props, forwardedRef) => {
    ...
    return visuallyHiddenContentContext.isInside ? null : (0, import_jsx_runtime41.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef });
  }
);
...
export {
  ...
  dist_exports37 as Toast,
  dist_exports2 as Toggle,
